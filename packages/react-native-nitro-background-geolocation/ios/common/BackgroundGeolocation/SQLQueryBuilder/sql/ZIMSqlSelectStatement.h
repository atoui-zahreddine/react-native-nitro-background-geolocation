...
/*!
 ...
 @updated				2012-03-24
 */
- (void) where: (id)column operator: (NSString *)sqlOperator value: (id)value; // wrap primitives with NSNumber
/*!
 ...
 @updated				2012-03-24
 */
- (void) where: (id)column operator: (NSString *)sqlOperator value: (id)value connector: (NSString *)connector; // wrap primitives with NSNumber
/*!
 @method				groupBy:
...
/*!
 ...
 @updated				2012-03-24
 */
- (void) groupByHaving: (id)column operator: (NSString *)sqlOperator value: (id)value; // wrap primitives with NSNumber
/*!
 ...
 @updated				2012-03-24
 */
- (void) groupByHaving: (id)column operator: (NSString *)sqlOperator value: (id)value connector: (NSString *)connector; // wrap primitives with NSNumber
/*!
 @method				orderBy:
