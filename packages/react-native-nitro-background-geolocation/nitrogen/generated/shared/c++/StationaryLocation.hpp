...
namespace margelo::nitro::nitrobackgroundgeolocation {
  ...
  /**
   * A struct which can be represented as a JavaScript object (StationaryLocation).
   */
  struct StationaryLocation final {
  public:
...
namespace margelo::nitro {
  ...
  // C++ StationaryLocation <> JS StationaryLocation (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrobackgroundgeolocation::StationaryLocation> final {
    static inline margelo::nitro::nitrobackgroundgeolocation::StationaryLocation fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrobackgroundgeolocation::StationaryLocation(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrobackgroundgeolocation::StationaryLocation& arg) {
