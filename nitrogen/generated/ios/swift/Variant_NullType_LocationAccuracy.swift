///
/// Variant_NullType_LocationAccuracy.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_LocationAccuracy {
  case first(NullType)
  case second(LocationAccuracy)
}

public extension Variant_NullType_LocationAccuracy {
