...
/**
 * Represents an instance of `LocationOptions`, backed by a C++ struct.
 */
public typealias LocationOptions = margelo.nitro.nitrobackgroundgeolocation.LocationOptions

public extension LocationOptions {
  private typealias bridge = margelo.nitro.nitrobackgroundgeolocation.bridge.swift

  /**
   * Create a new instance of `LocationOptions`.
   */
