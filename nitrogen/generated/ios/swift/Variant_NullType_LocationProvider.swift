///
/// Variant_NullType_LocationProvider.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_LocationProvider {
  case first(NullType)
  case second(LocationProvider)
}

public extension Variant_NullType_LocationProvider {
